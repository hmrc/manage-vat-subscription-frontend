...
class MockAppConfig(implicit val runModeConfiguration: Configuration) extends AppConfig {
  ...
  override val vatCorrespondenceChangeLandlineNumberUrl: String = "mock-change-phone-url"
  override val vatCorrespondenceChangeMobileNumberUrl: String = "mock-change-phone-url"
