...
object CustomerCircumstanceDetailsPageMessages extends BaseMessages {
  ...
  val phoneNumbersHeading = "Telephone numbers"
  ...
  val changePhoneNumbersHidden: String = "Change the landline and mobile telephone numbers"
  val pendingPhoneNumbersHidden: String = "Change to landline and mobile telephone numbers is pending"
