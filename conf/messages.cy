...
change_business_name.contactHMRC = gysylltu â CThEF (yn agor tab newydd).
change_business_name.p2 = Byddant yn anfon Tystysgrif Ymgorffori newydd ar ôl i’r manylion newid.
change_business_name.your = Bydd eich
change_business_name.bold1 = cyfrif treth busnes
change_business_name.p3 = yn dangos enw newydd eich busnes cyn pen 15 diwrnod.
change_business_name.p4 = Mae’n rhaid i chi roi gwybod i CThEF am y newid i enw’ch busnes cyn pen 30 diwrnod neu efallai y bydd angen i chi dalu cosb.
change_business_name.p5 = Dysgwch sut i newid enw’ch busnes a faint mae’n ei gostio (yn agor tab newydd).
change_business_name.link = Yn eich blaen i Dŷ’r Cwmnïau (yn agor tab newydd)

change_business_name.alternative.p1 = Enw’r busnes ar hyn o bryd yw
